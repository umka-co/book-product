...
const WhatIsNextPage = () => {
  return (
    ...
    >
      <Typo>
        Если вы не ошиблись в расчетах на стадии «идеи» и не врали себе при выборе «свой продукт» vs. «продажа чужого» —
        у вас в руках востребованный продукт. Это очень ценный актив!
      </Typo>
      <Typo>
        Все просто: Доставляйте продукт всем желающим, улучшайте и развивайте его. Несите клиентам радость и берите за
        это деньги.
      </Typo>
      ...
      <Typo>Но какие бы трудности ни ожидали вас на этом бизнес-пути, лучше где-то «удовлетворить спрос» и уйти в историю, чем просто смотреть на мир с «пассажирского кресла».</Typo>
    </BookPage>
  );
};
